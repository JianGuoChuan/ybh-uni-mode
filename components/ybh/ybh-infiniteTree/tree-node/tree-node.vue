<template>
	<view class="tree-item">
        <view class="head h-flex">
            <view class="head-1 flex-1" @click="changeShow" @touchstart="handletouchstart" @touchend="handletouchend">
            ...
            <view v-if="edit" class="p-t-20 p-r-30 flex">
				<view @click.stop="checkadditem">
					<u-icon name="plus-circle" :color="vuex_themeColor.color || '#0081ff'" size="40"></u-icon>
				</view>
				<view @click.stop="checkedititem" class="padding-left-sm">
					<u-icon name="edit-pen" :color="vuex_themeColor.color || '#0081ff'" size="40"></u-icon>
				</view>
				<view @click.stop="checkdeleteitem" class="padding-left-sm">
					<u-icon name="close-circle" :color="vuex_themeColor.color || '#0081ff'" size="40"></u-icon>
				</view>
                <!-- <image src="../static/rising.png" class="show-icon" @click.stop="checkupitem" /> -->
                <!-- <image src="../static/falling.png" class="show-icon" @click.stop="checkdownitem" /> -->
                <!-- <image src="../static/addblue.png" class="show-icon" @click.stop="checkadditem" />
                <image src="../static/editblue.png" class="edit-icon" @click.stop="checkedititem" />
                <image src="../static/reeorblue.png" class="show-icon" @click.stop="checkdeleteitem" /> -->
            </view>
        </view>
        <view class="content" 
